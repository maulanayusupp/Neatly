...
// Per-tool social preview image (generated by scripts/generate-og.mjs into
// /public/og/<slug>.png). Falls back to the shared og-image.png elsewhere.
const knownTool = computed(() => ALL_TOOLS.some(t => t.to === route.path))
const ogImage = computed(() =>
  knownTool.value && route.path !== '/'
    ? `${siteUrl}/og${route.path}.png`
